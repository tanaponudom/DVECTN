...
public class Fragment_Teacher_Recycle extends Fragment implements View.OnClickListener {
    Bundle bd_tch;
    String str_tch;
    List<String> Data_th;
            ...
            public void onClick(View view) {
                switch (view.getId()){
                    case R.id.fab1:
                        ...
                        Fragment_Teacher_Recycle fragment_Teacher_Recycle = new Fragment_Teacher_Recycle();
