...
import ctn.example.user.dvectn.Retrofit.OnNetworkCallback_PJ_P5;
...
public class Fragment_bt_pj_5 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(ctn.example.user.dvectn.R.id.bbbtn6).setOnClickListener(this);
        ((AppCompatActivity) getActivity()).getSupportActionBar().show();
...
//                        , Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case  ctn.example.user.dvectn.R.id.bbbtn6:
