...
import ctn.example.user.dvectn.Fragment.Student_save;
import ctn.example.user.dvectn.POJO.POJO_Stu_naja;
import ctn.example.user.dvectn.Retrofit.NetworkConnectionManager;
import ctn.example.user.dvectn.Retrofit.OnNetworkCallback_Stu_naja;
...
public class Fragment_Student_Recycel extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View viewtt = inflater.inflate(ctn.example.user.dvectn.R.layout.student_page, container, false);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    ...
                    case ctn.example.user.dvectn.R.id.fab:
        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    ...
                    case ctn.example.user.dvectn.R.id.fab12:
...
//                        replaceFragment(fragment_login,null);
        ...
        recyclerView = viewtt.findViewById(ctn.example.user.dvectn.R.id.LV_st_1);
