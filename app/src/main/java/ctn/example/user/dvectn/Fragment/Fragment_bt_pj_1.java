...
import ctn.example.user.dvectn.Retrofit.OnNetworkCallback_PJ_P1;
...
public class Fragment_bt_pj_1 extends Fragment implements OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(ctn.example.user.dvectn.R.layout.av_bt_pj_1, container, false);
        context = getContext();

        CB1 = view.findViewById(ctn.example.user.dvectn.R.id.CB1);
        CB1.setChecked(false);

        CB2 = view.findViewById(ctn.example.user.dvectn.R.id.CB2);
        CB2.setChecked(false);

        CB3 = view.findViewById(ctn.example.user.dvectn.R.id.CB3);
        CB3.setChecked(false);

         CB4 = view.findViewById(ctn.example.user.dvectn.R.id.CB4);
        CB4.setChecked(false);


        view.findViewById(ctn.example.user.dvectn.R.id.CB1).setOnClickListener(this);
        view.findViewById(ctn.example.user.dvectn.R.id.CB2).setOnClickListener(this);
        view.findViewById(ctn.example.user.dvectn.R.id.CB3).setOnClickListener(this);
        view.findViewById(ctn.example.user.dvectn.R.id.CB4).setOnClickListener(this);

        view.findViewById(ctn.example.user.dvectn.R.id.btn_confirm).setOnClickListener(this);
...
public void replaceFragment(Fragment fragment, Bundle bundle) {
    ...
    switch (v.getId()){
        case ctn.example.user.dvectn.R.id.CB1:
            ex11_tmp = 1;
            CB2.setChecked(false);
            break;
        case ctn.example.user.dvectn.R.id.CB2:
             ex11_tmp = 2;
             CB1.setChecked(false);
            break;
        case ctn.example.user.dvectn.R.id.CB3:
            ex12_tmp = 1;
            CB4.setChecked(false);
            break;
        case ctn.example.user.dvectn.R.id.CB4:
            ex12_tmp = 2;
            CB3.setChecked(false);
            break;
        case ctn.example.user.dvectn.R.id.btn_confirm:
