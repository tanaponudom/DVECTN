...
import ctn.example.user.dvectn.Retrofit.OnNetworkCallback_getstuemp;
...
public class Fragment_Teacher_Trainer extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View viewtcher = inflater.inflate(ctn.example.user.dvectn.R.layout.teacher_fusionjob,container,false);
        context = getContext();
        ...
        recyclerView2 = viewtcher.findViewById(ctn.example.user.dvectn.R.id.LV_thnaja_1);
