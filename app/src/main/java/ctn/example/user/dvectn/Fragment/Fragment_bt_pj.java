...
public class Fragment_bt_pj extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view4 = inflater.inflate(ctn.example.user.dvectn.R.layout.av_bt_pj, container, false);
        view4.findViewById(ctn.example.user.dvectn.R.id.BTNN_1).setOnClickListener(this);
        view4.findViewById(ctn.example.user.dvectn.R.id.BTNN_2).setOnClickListener(this);
        view4.findViewById(ctn.example.user.dvectn.R.id.BTNN_3).setOnClickListener(this);
        view4.findViewById(ctn.example.user.dvectn.R.id.BTNN_4).setOnClickListener(this);
        view4.findViewById(ctn.example.user.dvectn.R.id.BTNN_5).setOnClickListener(this);
        view4.findViewById(ctn.example.user.dvectn.R.id.BTNN_6).setOnClickListener(this);
