...
import ctn.example.user.dvectn.Retrofit.OnNetworkCallback_DD_P1;
...
public class Fragment_bt_dd_1 extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(ctn.example.user.dvectn.R.id.bbbtn1).setOnClickListener(this);
...
//                        , Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case  ctn.example.user.dvectn.R.id.bbbtn1:
