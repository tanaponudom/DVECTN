...
public class Fragment_bt_pd1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view2 = inflater.inflate(ctn.example.user.dvectn.R.layout.av_bt_pd,container,false);
        context = getContext();
...
//        Toast.makeText(context, ""+dep_id, Toast.LENGTH_SHORT).show();
        ...
        recycleView = view2.findViewById(ctn.example.user.dvectn.R.id.LV_bt_pd);
