...
import ctn.example.user.dvectn.Retrofit.OnNetworkCallback_PJ_P2;
...
public class Fragment_bt_pj_2 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(ctn.example.user.dvectn.R.id.bbbtn3).setOnClickListener(this);
...
//                        +" , "+tmpSpn[6]+" , "+tmpSpn[7]+" , "+memberId, Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case  ctn.example.user.dvectn.R.id.bbbtn3:
